...
public:
	...
	//Accessors//
	//Verts by data
	bool CheckVert(V data);
	void SetFlag(V data);
	bool CheckFlag(V data);
	E GetEdge(V data, V connects);
	int GetWeight(V data, V connects);

	//Edge Iterators
	typename list<Edge<V, E>>::const_iterator GetEdgeIter(V data);
	typename list<Edge<V, E>>::const_iterator GetEdgeIterEnd(V data);
...
{
	//if (identical vert doesn't already exist)
	if (!CheckVert(data))
	{
		//create new vertex
...
template<class V, class E>
inline bool Graph<V, E>::CheckVert(V data)
{
...
template<class V, class E>
inline void Graph<V, E>::SetFlag(V data)
{
	Vertex<V, E>* vert = Find(data);
	vert->m_flag = true;
}

template<class V, class E>
inline bool Graph<V, E>::CheckFlag(V data)
{
	Vertex<V, E>* vert = Find(data);
	return vert->m_flag;
}
...
template<class V, class E>
inline E Graph<V, E>::GetEdge(V data, V connects)
{
	Vertex<V, E>* vert = Find(data);
	typename list<Edge<V, E>>::iterator i;
	for (i = vert->m_edges.begin(); i != vert->m_edges.end(); i++)
	{
		if (i->m_vert->GetData() == connects)
		{
			return i->m_data;
		}
	}
...
template<class V, class E>
inline int Graph<V, E>::GetWeight(V data, V connects)
{
	Vertex<V, E>* vert = Find(data);
	typename list<Edge<V, E>>::iterator i;
	for (i = vert->m_edges.begin(); i != vert->m_edges.end(); i++)
...
template<class V, class E>
inline typename list<Edge<V, E>>::const_iterator Graph<V, E>::GetEdgeIter(V data)
{
	Vertex<V, E>* vert = Find(data);
	typename list<Edge<V, E>>::const_iterator i = vert->m_edges.begin();
	return i;
}

template<class V, class E>
inline typename list<Edge<V, E>>::const_iterator Graph<V, E>::GetEdgeIterEnd(V data)
{
	Vertex<V, E>* vert = Find(data);
	typename list<Edge<V, E>>::const_iterator i = vert->m_edges.end();
	return i;
}
